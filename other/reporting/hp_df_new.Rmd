---
title: "CeMoRe Harbour Porpoise Detection Function Exploration"
author: "Elise Keppel"
date: "`r Sys.Date()`"
output: pdf_document
fig_caption: true
...
all_ap_sf <- readRDS(paste0("../output/all_sgt/all_effort_sgt_to_", year, "_",month, ".rds")) %>% left_join(iterations)
...
all_ap_sf <- all_ap_sf %>% 
  ...
  mutate(Beaufort = as.numeric(as.character(Beaufort)),
         ...
         Glare90y = ifelse(Glare90=="None","n","y"),
...
non-reticle sightings removed there are plenty of reticle sightings
...
hist(sf_ret$distance, xlab="Distance (km)", breaks=seq(0,max(sf$distance),len=40),
     main=paste0("To ", survey_title, " - ", "bins - ret only"))
...
N = `r n` reticle sightings, `r n-n_ret` eye-balled distance sightings discarded
...
file <- paste0(dir,"hp_hn",survey_title)
...
file <- paste0(dir,"hp_hr",survey_title)
if(!rerun & file.exists(file)){
  load(file)
}else{
...
file <- paste0(dir,"hp_un",survey_title)
if(!rerun & file.exists(file)){
  load(file)
}else{
...
Truncating tabled beaufort data to 0.8 km.
```{r beau}
df1 <- df %>% filter(distance <= 0.8)
table(df1$Beaufort)
...
```{r beau-hn-hr}
file <- paste0(dir,"hp_hn_hr_bf",survey_title)
if(!rerun & file.exists(file)){
  load(file)
}else{
...
file <- paste0(dir,"hp_hn_hr_bfc_bfcb",survey_title)
if(!rerun & file.exists(file)){
  load(file)
}else{
...
file <- paste0(dir,"hp_hn_hr_sz",survey_title)
if(!rerun & file.exists(file)){
  load(file)
}else{
...
hn.gl1 <- ds(data=df, truncation=1, key="hn", adjustment=NULL, formula=~Glare90)
hr.gl1 <- ds(data=df, truncation=1, key="hr", adjustment=NULL, formula=~Glare90)
hn.gl0.8 <- ds(data=df, truncation=0.8, key="hn", adjustment=NULL, formula=~Glare90)
hr.gl0.8 <- ds(data=df, truncation=0.8, key="hr", adjustment=NULL, formula=~Glare90)
hn.gl0.7 <- ds(data=df, truncation=0.7, key="hn", adjustment=NULL, formula=~Glare90)
hr.gl0.7 <- ds(data=df, truncation=0.7, key="hr", adjustment=NULL, formula=~Glare90)
hn.gl0.65 <- ds(data=df, truncation=0.65, key="hn", adjustment=NULL, formula=~Glare90)
hr.gl0.65 <- ds(data=df, truncation=0.65, key="hr", adjustment=NULL, formula=~Glare90)

hn.gl45.1 <- ds(data=df, truncation=1, key="hn", adjustment=NULL, formula=~Glare45)
hr.gl45.1 <- ds(data=df, truncation=1, key="hr", adjustment=NULL, formula=~Glare45)
hn.gl45.0.8 <- ds(data=df, truncation=0.8, key="hn", adjustment=NULL, formula=~Glare45)
hr.gl45.0.8 <- ds(data=df, truncation=0.8, key="hr", adjustment=NULL, formula=~Glare45)
hn.gl45.0.7 <- ds(data=df, truncation=0.7, key="hn", adjustment=NULL, formula=~Glare45)
hr.gl45.0.7 <- ds(data=df, truncation=0.7, key="hr", adjustment=NULL, formula=~Glare45)
hn.gl45.0.65 <- ds(data=df, truncation=0.65, key="hn", adjustment=NULL, formula=~Glare45)
hr.gl45.0.65 <- ds(data=df, truncation=0.65, key="hr", adjustment=NULL, formula=~Glare45)
...
hn.gl1y <- ds(data=df, truncation=1, key="hn", adjustment=NULL, formula=~Glare90y)
hr.gl1y <- ds(data=df, truncation=1, key="hr", adjustment=NULL, formula=~Glare90y)
hn.gl0.8y <- ds(data=df, truncation=0.8, key="hn", adjustment=NULL, formula=~Glare90y)
hr.gl0.8y <- ds(data=df, truncation=0.8, key="hr", adjustment=NULL, formula=~Glare90y)
hn.gl0.7y <- ds(data=df, truncation=0.7, key="hn", adjustment=NULL, formula=~Glare90y)
hr.gl0.7y <- ds(data=df, truncation=0.7, key="hr", adjustment=NULL, formula=~Glare90y)
hn.gl0.65y <- ds(data=df, truncation=0.65, key="hn", adjustment=NULL, formula=~Glare90y)
hr.gl0.65y <- ds(data=df, truncation=0.65, key="hr", adjustment=NULL, formula=~Glare90y)

hn.gl45.1y <- ds(data=df, truncation=1, key="hn", adjustment=NULL, formula=~Glare45y)
hr.gl45.1y <- ds(data=df, truncation=1, key="hr", adjustment=NULL, formula=~Glare45y)
hn.gl45.0.8y <- ds(data=df, truncation=0.8, key="hn", adjustment=NULL, formula=~Glare45y)
hr.gl45.0.8y <- ds(data=df, truncation=0.8, key="hr", adjustment=NULL, formula=~Glare45y)
hn.gl45.0.7y <- ds(data=df, truncation=0.7, key="hn", adjustment=NULL, formula=~Glare45y)
hr.gl45.0.7y <- ds(data=df, truncation=0.7, key="hr", adjustment=NULL, formula=~Glare45y)
hn.gl45.0.65y <- ds(data=df, truncation=0.65, key="hn", adjustment=NULL, formula=~Glare45y)
hr.gl45.0.65y <- ds(data=df, truncation=0.65, key="hr", adjustment=NULL, formula=~Glare45y)
...
file <- paste0(dir,"hp_hn_hr_vis",survey_title)
if(!rerun & file.exists(file)){
  load(file)
}else{
...
hn.obs0.65 <- ds(data=df, truncation=0.65, key="hn", formula=~SightedBy)
hr.obs0.65 <- ds(data=df, truncation=0.65, key="hr", formula=~SightedBy)
...
par(mfrow=c(1,2))
plot_df(sp, hn.obs0.65)
plot_df(sp, hr.obs0.65)
par(mfrow=c(1,2))
gof_ds(hn.obs0.65, main="hn.obs0.65")
gof_ds(hr.obs0.65, main="hr.obs0.65")
```
...
# 
# kableExtra::kable(model.table.1km, digits=3, row.names = FALSE, escape=FALSE,
#       caption = paste(sp, " - Comparison of half normal and hazard rate with single covariates. Truncation = 1 km.")) %>%
#   kableExtra::footnote(paste0("* ", tab.ft1)) %>% 
#   kableExtra::landscape()
#----------------------------------------------------
model.table.0.8km <- summarize_ds_models(
...
# 
# kableExtra::kable(model.table.0.65km, digits=3, row.names = FALSE, escape=FALSE,
#       caption = paste(sp, " - Comparison of half normal and hazard rate with single covariates. Truncation = 0.65 km.")) %>%
#   kableExtra::footnote(paste0("* ", tab.ft0.65)) %>% 
#   kableExtra::landscape()
...
hn.obs.bf0.8   <- ds(data=df, truncation=0.8, key="hn", formula=~SightedBy+Beaufort)
hr.obs.bf0.8   <- ds(data=df, truncation=0.8, key="hr", formula=~SightedBy+Beaufort)
hn.szc.bf0.8     <- ds(data=df, truncation=0.8, key="hn", formula=~szc+Beaufort)
hr.szc.bf0.8     <- ds(data=df, truncation=0.8, key="hr", formula=~szc+Beaufort)
# hn.obs.v.bf0.8 <- ds(data=df, truncation=0.8, key="hn", formula=~SightedBy+vis+bf)
# hr.obs.v.bf0.8 <- ds(data=df, truncation=0.8, key="hr", formula=~SightedBy+vis+bf)
...
hn.obs.bf0.7   <- ds(data=df, truncation=0.7, key="hn", formula=~SightedBy+Beaufort)
hr.obs.bf0.7   <- ds(data=df, truncation=0.7, key="hr", formula=~SightedBy+Beaufort)
hn.szc.bf0.7   <- ds(data=df, truncation=0.7, key="hn", formula=~szc+Beaufort)
hr.szc.bf0.7   <- ds(data=df, truncation=0.7, key="hr", formula=~szc+Beaufort)
...
<!-- ```{r plot_best_models} -->
<!-- par(mfrow=c(1,3)) -->
<!-- plot_df(sp, hr.0.7,showpoints=F) -->
<!-- plot_df(sp, hn.obs.bfc0.7,showpoints=F) -->
<!-- plot_df(sp, hn.bf0.7c,showpoints=F) -->
<!-- par(mfrow=c(1,3)) -->
<!-- plot_df(sp, hn.bf0.8,showpoints=F) -->
<!-- plot_df(sp, hn.szc.bfc0.8,showpoints=F) -->
<!-- plot_df(sp, hn.bf0.8c,showpoints=F) -->
<!-- par(mfrow=c(1,3)) -->
<!-- gof_ds(hr.0.7, main="hr.0.7") -->
<!-- gof_ds(hn.obs.bfc0.7, main="hn.obs.bfc0.7") -->
<!-- gof_ds(hn.bf0.7c, main="hn.bf0.7c") -->
<!-- par(mfrow=c(1,3)) -->
<!-- gof_ds(hn.bf0.8, main="hn.bf0.8") -->
<!-- gof_ds(hn.szc.bfc0.8, main="hn.szc.bfc0.8") -->
<!-- gof_ds(hn.bf0.8c, main="hn.bf0.8c") -->
